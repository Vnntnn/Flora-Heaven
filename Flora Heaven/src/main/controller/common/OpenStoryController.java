...
import main.view.Gamewindow.lobby.OpenStoryPage;
import javax.swing.*;
import java.awt.*;
import java.io.*;
import java.net.URL;
...
public class OpenStoryController {
    ...
    private void initialize() throws IOException, FontFormatException {
        loadResources();
        Map<String, OpenStoryPage.StoryLabelInfo> labelInfos = createLabelInfos();
        view = new OpenStoryPage(customFont, backgroundImage, labelInfos);
        setupEventListeners();
        view.show();
    }
    ...
    private Map<String, OpenStoryPage.StoryLabelInfo> createLabelInfos() {
        ...
        labelInfos.put("ending", new OpenStoryPage.StoryLabelInfo(
